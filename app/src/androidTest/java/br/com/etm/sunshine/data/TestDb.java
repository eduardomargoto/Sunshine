package br.com.etm.sunshine.data;
...
import static br.com.etm.sunshine.data.WeatherContract.LocationEntry;
import static br.com.etm.sunshine.data.WeatherContract.WeatherEntry;

/**
 * Created by EDUARDO_MARGOTO on 12/1/2016.
 */
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable(Context context) {
        ...
        long idLocation;
        idLocation = db.insert(LocationEntry.TABLE_NAME, null, testValues);


        // Create ContentValues of what you want to insert
        // Verify we got a row back.
        assertTrue(idLocation != -1);
        // Insert ContentValues into database and get a row ID back

        // Query the database and receive a Cursor back
        Cursor cursor = db.query(LocationEntry.TABLE_NAME, null, null, null, null, null, null);
        // Move the cursor to a valid database row
        assertTrue("Error: No results returned from location query.", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        TestUtilities.validateCurrentRecord("Error: Data Invalid", cursor, testValues);
    ...
    public void testWeatherTable() {
        ...
        long idLocation = testLocationTable(getContext());
        ...
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        // Create ContentValues of what you want to insert
        ContentValues testValues = TestUtilities.createWeatherValues(idLocation);
        // (you can use the createWeatherValues TestUtilities function if you wish)


        // Insert ContentValues into database and get a row ID back
        long idWeather;
        idWeather = db.insert(WeatherEntry.TABLE_NAME, null, testValues);
        // Query the database and receive a Cursor back
        assertTrue(idWeather != -1);
        // Move the cursor to a valid database row
        ...
        assertTrue("Error: No results returned from Weather query.", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues

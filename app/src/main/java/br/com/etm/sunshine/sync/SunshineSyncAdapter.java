package br.com.etm.sunshine.sync;
...
//            final String FORECAST_BASE_URL = "http://google.com/?"; // INVALID
//            final String FORECAST_BASE_URL = "http://google.com/ping?"; // EMPTY
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (forecastJson.has(OWM_MESSAGE_CODE)) {
                ...
                Log.v(LOG_TAG, "errorCode: " + errorCode);
                switch (errorCode) {
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    builderNotification.setContentTitle(title);
                    builderNotification.setContentText(contentText);
                    builderNotification.setSmallIcon(iconId);

                    if (intent != null)
                        builderNotification.setContentIntent(p);
                    ...
                    mNotificationManager.notify(WEATHER_NOTIFICATION_ID, builderNotification.build());
